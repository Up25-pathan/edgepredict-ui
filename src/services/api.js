...
// FIX: Removed the 'headers' object. Axios will automatically detect JSON vs FormData.
...
const api = {
  ...
  // --- Simulations ---
    createSimulation: (formData) => {
        // FIX: No manual headers. Browser will handle boundary automatically.
