...
// NEW: Import icons for admin links
        ...
        <>
            <div className="w-64 bg-hud-surface border-r border-hud-border flex flex-col p-4 shrink-0">
                ...
                <nav className="flex-1 space-y-1">
                    ...
                    {/* --- NEW: ADMIN SECTION --- */}
                    {/* This block only renders if the logged-in user is an admin */}
                    {user?.is_admin && (
                        <>
                            ...
                            <NavLink to="/admin/users" className={navLinkClasses}>
                                ...
                                <span className="ml-3 text-indigo-100">User Management</span>
                            </NavLink>
                            <NavLink to="/admin/requests" className={navLinkClasses}>
                                <Inbox className="w-6 h-6 text-indigo-400" />
                                <span className="ml-3 text-indigo-100">Access Requests</span>
                            </NavLink>
                        </>
                    )}
                    {/* --- END ADMIN SECTION --- */}
