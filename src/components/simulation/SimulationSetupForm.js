...
const SimulationSetupForm = () => {
    ...
    const [timeStepDuration, setTimeStepDuration] = useState(0.01);
    const [ambientTemp, setAmbientTemp] = useState(25.0);
    const [heatCoeff, setHeatCoeff] = useState(50.0);
    const [strainRate, setStrainRate] = useState(50000.0);
    ...
    const handleSubmit = async (e) => {
        ...
        // --- FIX: Assemble the physics_parameters object ---
        ...
        formData.append('physics_parameters', JSON.stringify(physics_parameters)); // <-- FIX: Add to form data
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-gray-800 rounded-lg">
            ...
            {/* --- FIX: Added Physics and Simulation Parameters section back --- */}
