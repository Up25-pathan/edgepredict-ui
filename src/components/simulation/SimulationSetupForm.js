...
const SimulationSetupForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // FIX 1: Safely handle material properties. 
        // If it's an object (JSON), stringify it. If it's a string, send as is.
        const matProps = typeof mat.properties === 'object' 
            ? JSON.stringify(mat.properties) 
            : mat.properties;
        formData.append('material_properties', matProps); 
        ...
        try {
            ...
            // FIX 2: Better error parsing to avoid "[object Object]"
